...
/*Google Tag script into head tag*/
...
/*Google Tag script into body tag*/
$(document).ready(function(){
$( 'body' ).prepend( '<!-- Google Tag Manager (noscript) --><noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WZ4QLHS"height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><!-- End Google Tag Manager (noscript) -->');
});
