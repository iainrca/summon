 ...
 function AppendToHoldings() {
	  ...
	  if(invalidSMLocs.indexOf(Loc) == -1) {
	     // get bib id and append shelfmap url/link
                  $( "<div id='shelfmap'><a href='https://app.shelfmap.co.uk/fp/fp?icode=44RCA&id=" + bibid + "' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'><img src='https://iainrca.github.io/summon/v2.png' alt='ShelMap drop pin' height = '25px' width='21px'/>  Show Book on Map</a></div></br>").insertAfter( $(this) );
               }
          if (Loc == 'CRL') {
