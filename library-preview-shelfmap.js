...
/*function to append text to records where the RTA Location Code requires users to do something*/
 ...
 function AppendToHoldings() {
	      ...
	      $( "<div id='shelfmap'><a href='https://app.shelfmap.co.uk?icode=44RCA&id=' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'>Take me t'Book</a></br></div>" ).insertAfter( $(this) );
			}
