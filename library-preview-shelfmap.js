 ...
 function AppendToHoldings() {
	  ...
	  if(invalidSMLocs.indexOf(Loc) == -1) {
	     // get bib id and append shelfmap url/link
	      $( "<span><a href='https://app.shelfmap.co.uk/fp/fp?icode=44RCA&id=" + bibid + "' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'><img src= alt='ShelMap drop pin' />Show me the book</a></span></br>").insertAfter( $(this) );
   	  }		  
          if (Loc == 'CRL') {
