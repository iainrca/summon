...
/*function to append text to records where the RTA Location Code requires users to do something*/
 ...
 function AppendToHoldings() {
	  ...
	  var bibid = $(this).closest($('div.documentSummary')).attr('id').replace(/FETCH-rca_catalog_u/g,'').replace(/.$/,'');	  	  	  	  
          var invalidSMLocs=["SPECCOLL","CRL","AB","ARC","THESES","STACK","FLTV","OFFSITE","PER_NONC","PER_RES","CAT","IP","JR","ONORD","EBOOKS","ONLOAN"];
	  ...
	  if(invalidSMLocs.indexOf(Loc) == -1) {
	     // get bib id and append shelfmap url/link
	      $( "<div id='shelfmap'><a href='https://app.shelfmap.co.uk/fp/fp?icode=44RCA&id=" + bibid + "' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'><img src='https://iainrca.github.io/summon/me_logo.png' alt='ShelMap drop pin' />  Show Item on ShelfMap</a></div></br>").insertAfter( $(this) );
   	  }		  
          if (Loc == 'CRL') {
